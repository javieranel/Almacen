    ...
    <div class="container mt-4">
        ...
        <div class="card p-3 mb-3">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <h4 class="text-center flex-grow-1">Control de Salida de Herramientas</h4>
            </div>
        </div>
        ...
        function activarAutocompleteInsumos() {
            ...
            document.querySelectorAll(".insumo_input").forEach(input => {
                ...
                input.addEventListener("keyup", function() {
                    ...
                    fetch(`../ajax/buscar_herramientas.php?term=${valor}`)
                        .then(res => res.json())
                        .then(data => {
...
<td><button class="btn btn-danger btn-sm" onclick="this.closest('tr').remove()">X</button></td>
        ...
        function guardar() {
            ...
            let firma1 = pads["firma1"] && !pads["firma1"].isEmpty() ?
                pads["firma1"].toDataURL() :
                "";

            let firma2 = pads["firma2"] && !pads["firma2"].isEmpty() ?
                pads["firma2"].toDataURL() :
                "";
            ...
            if (detalle.length === 0) {
                Swal.fire('Error', 'Agrega herramientas', 'warning');
                return;
            }
            ...
            fetch("../ajax/salidas_herramientas.php", {
                    method: "POST",
                    headers: {
